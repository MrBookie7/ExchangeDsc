<#
    .SYNOPSIS
        Automated integration test for DSC_ExchEcpVirtualDirectory DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchEcpVirtualDirectory'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchEcpVirtualDirectory' {
        $testParams = @{
