<#
    .SYNOPSIS
        Automated integration test for DSC_ExchOwaVirtualDirectory DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchOwaVirtualDirectory'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchOwaVirtualDirectory' {
        $testParams = @{
